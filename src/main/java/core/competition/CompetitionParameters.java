...
public class CompetitionParameters {
   ...
   * ttttttt
   */
  public static final int ACTION_TIME = 4000;
   ...
   */
  public static final int INITIALIZATION_TIME = 100000000;
  ...
  /**
   * Use sockets for Learning track connection? (NOTE: Client code should also be configured to use sockets - or not).
   */
  ...
  /**
   * Indicates if the overspend should be taken into account or not. Time limits are WALL TIME on Windows, because CPU TIME is not accurate enough at the level
   * of milliseconds on this OS.
   */
