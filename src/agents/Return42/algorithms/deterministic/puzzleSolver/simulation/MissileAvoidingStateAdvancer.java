package agents.Return42.algorithms.deterministic.puzzleSolver.simulation;
...
import agents.Return42.hashing.MovableHasher;
...
public class MissileAvoidingStateAdvancer implements AStarAdvanceFunction {
	...
	private boolean didUserCollideWithMovable(StateObservation oldState, StateObservation newState ) {
		Collection<Event> newEvents = extractNewEvents( oldState.getHistoricEventsHistory(), newState.getHistoricEventsHistory() );
