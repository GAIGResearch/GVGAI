package agents.Return42.algorithms.pattern;

import agents.Return42.GameStateCache;
import agents.Return42.heuristics.patterns.EnemyPattern;
import agents.Return42.heuristics.patterns.Pattern;
...
public class Agent extends AbstractPlayer {
    ...
    public Agent(StateObservation so, ElapsedCpuTimer elapsedTimer) {
        ...
        fallback = new agents.Return42.algorithms.GA.Agent(so, elapsedTimer);
    }
