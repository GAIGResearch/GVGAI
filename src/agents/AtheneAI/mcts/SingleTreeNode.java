...
public class SingleTreeNode {
	...
	public double value(StateObservation a_gameState, Heatmap map, int depth) {
		...
		boolean collision = !a_gameState.getHistoricEventsHistory().isEmpty()
				&& a_gameState.getHistoricEventsHistory().last().gameStep == a_gameState.getGameTick() - 1;

		if (collision) {
			Event e = a_gameState.getHistoricEventsHistory().last();
